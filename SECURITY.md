...
| ------- | ------------------ | --------------- |
| 1.23+   | :white_check_mark: | **8 critical vulnerabilities fixed (2026-07-10)** |
| 1.22    | :white_check_mark: | ⚠️ Contains known vulnerabilities - upgrade to 1.23+ |
| < 1.22  | :x:                | Not supported |
